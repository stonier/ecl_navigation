/**
 * @file /src/test/grid_map_dynamic.cpp
 *
...
int main(int argc, char **argv) {
    ...
    GridMap<Cell> map(5,5, 0.0,0.0,2.0);
    GridMap<Cell> map2(5,5, 0.0, 0.0, 1.0 );
    ...
    cout << endl;
	cout << "***********************************************************" << endl;
	cout << "                  Comparison and remap" << endl;
	cout << "***********************************************************" << endl;
	if( map == map2 )
	{
		std::cout <<"map is equal to map2 " << std::endl;
	}
	else
	{
		std::cout <<"map is not equal to map2 " << std::endl;
	}

	std::cout << "Performs map2=map" << std::endl;
	map2 = map;

	for ( j = map2.rows(); j > 0; --j ) {
		unsigned int index = j - 1;
		for ( i = 0; i < map2.cols(); ++i ) {
			std::cout << "[" << map2(i,index).i << "," << map2(i,index).j << "]";
		}
		std::cout << std::endl;
	}
	std::cout << std::endl;
